import { a as api, g as getFileThumbnailUrl, b as getFilePreviewUrlSmart, c as getCachedImageUrl, _ as _export_sfc, f as formatFileSize, d as downloadFile, e as getFilePreviewUrl, p as preloadImage, u as useAuthStore, h as formatTime, i as copyToClipboard } from "./index-h0KlDSqm.js";
/* empty css                         */
/* empty css                */
/* empty css                   */
/* empty css                      */
    ...
    const batchDelete = async () => {
      ...
      try {
        ...
        for (const itemId of selectedFiles.value) {
          ...
          const item = allItems2.find((item2) => item2.id === itemId || item2.id === Number(itemId));
          if (item) {
            if (item.isFolder) {
        ...
        if (filesToDelete.length > 0) {
          const fileIds = filesToDelete.map((f) => f.id).filter((id) => typeof id === "number" && !Number.isNaN(id));
          try {
...
const Files = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-073b30d8"]]);
export {
  Files as default
};
//# sourceMappingURL=Files-DXiFojSX.js.map
