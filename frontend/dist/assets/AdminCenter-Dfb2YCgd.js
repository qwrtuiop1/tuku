import { a as api, h as getAvatarUrl, f as formatFileSize, _ as _export_sfc } from "./index--zNjtHoG.js";
/* empty css                              */
/* empty css                    */
/* empty css                   */
/* empty css                         */
...
import { af as data_board_default, u as user_filled_default, o as document_default, i as folder_default, a2 as setting_default, $ as circle_check_default, E as ElMessage, c as ElButton, a1 as ElCard, q as ElDialog, ag as ElRow, a as ElIcon, K as refresh_default, ah as ElMenu, ai as ElMenuItem, aj as ElCol, ak as arrow_up_default, b as ElForm, d as ElFormItem, e as ElInput, L as search_default, Y as ElSelect, Z as ElOption, al as ElDatePicker, am as plus_default, C as delete_default, an as vLoading, a0 as ElAvatar, X as ElTag, z as ElProgress, g as ElCheckbox, D as ElDropdown, ao as arrow_down_default, N as ElDropdownMenu, O as ElDropdownItem, f as user_default, ap as switch_default, A as folder_opened_default, aq as data_analysis_default, a6 as ElEmpty, V as ElTable, W as ElTableColumn, ar as more_filled_default, as as key_default, w as download_default, at as ElDivider, _ as ElInputNumber, au as ElSwitch, h as upload_default, av as ElCheckboxGroup, aw as tools_default, ax as brush_default, ay as ElRadioGroup, az as ElRadioButton, aA as ElColorPicker, p as picture_default, aB as star_default, U as view_default, ac as ElSlider, I as ElMessageBox } from "./element-CUddkawN.js";
  ...
  setup(__props) {
    ...
    const showUserStats = async (user) => {
      ...
      try {
        ...
        } else if (((_e = error.response) == null ? void 0 : _e.status) === 403) {
          ElMessage.error("没有权限访问用户统计信息");
          showUserStatsDialog.value = false;
        } else if (((_f = error.response) == null ? void 0 : _f.status) >= 500) {
          ElMessage.error("服务器错误，请稍后重试");
          showUserStatsDialog.value = false;
        } else {
          const errorMsg = ((_h = (_g = error.response) == null ? void 0 : _g.data) == null ? void 0 : _h.message) || error.message || "获取用户统计失败";
...
const AdminCenter = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8e06907c"]]);
export {
  AdminCenter as default
};
//# sourceMappingURL=AdminCenter-Dfb2YCgd.js.map
