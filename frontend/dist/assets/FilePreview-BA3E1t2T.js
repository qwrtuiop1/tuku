import { a as api, f as formatFileSize, _ as _export_sfc, b as getFilePreviewUrl, c as formatTime, g as getCachedImageUrl } from "./index--zNjtHoG.js";
/* empty css                    */
...
import { a as ElIcon, h as upload_default, c as ElButton, v as video_play_default, n as loading_default, z as ElProgress, I as ElMessageBox, E as ElMessage, a8 as clock_default, a9 as check_default, aa as close_default, ab as video_pause_default, ac as ElSlider, ad as microphone_default, ae as mute_default, y as full_screen_default, p as picture_default, K as refresh_default, o as document_default } from "./element-CUddkawN.js";
/* empty css                   */
/* empty css                         */
/* empty css                   */
...
const _hoisted_7$2 = { class: "upload-progress" };
const _hoisted_8$2 = { class: "progress-text" };
const _hoisted_9$2 = ["accept"];
const _hoisted_10$2 = {
  key: 0,
  class: "upload-list"
};
const _hoisted_11$1 = { class: "upload-list-header" };
const _hoisted_12 = { class: "upload-items" };
const _hoisted_13 = { class: "item-thumbnail" };
...
const _hoisted_18 = { class: "item-size" };
const _hoisted_19 = { class: "item-progress" };
const _hoisted_20 = { class: "item-status" };
const _hoisted_21 = { class: "item-actions" };
const _hoisted_22 = {
  key: 1,
  class: "upload-stats"
};
const _hoisted_23 = { class: "stats-item" };
const _hoisted_24 = { class: "stats-value" };
const _hoisted_25 = { class: "stats-item" };
const _hoisted_26 = { class: "stats-value success" };
const _hoisted_27 = { class: "stats-item" };
const _hoisted_28 = { class: "stats-value error" };
const _hoisted_29 = {
  key: 2,
  class: "live-jobs"
};
const _hoisted_30 = { class: "live-jobs-items" };
const _hoisted_31 = { class: "job-info" };
const _hoisted_32 = { class: "job-id" };
const _hoisted_33 = { class: "job-status" };
const _hoisted_34 = { class: "job-actions" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    const { isSupported: photosPickerSupported, isLoading: photosPickerLoading, openPhotosPicker } = useLivePhotoPicker({
      onPicked: async (results) => {
        ...
        for (const result of results) {
          ...
          try {
            const resp2 = await api.post("/live-media/upload", fd, {
              headers: { "Content-Type": "multipart/form-data" }
            });
            const jobId = normalizeJobId((_a = resp2.data) == null ? void 0 : _a.jobId);
    ...
    const handleLiveSelect = async (e) => {
      ...
      try {
        ...
        const resp2 = await api.post("/live-media/upload", formData, {
          headers: { "Content-Type": "multipart/form-data" },
          onUploadProgress: (pe) => {
    ...
    const processFiles = async (files) => {
      ...
      const usedMovs = /* @__PURE__ */ new Set();
      ...
      movs.forEach((m) => {
        if (!usedMovs.has(m.name)) others.push(m);
      });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        createBaseVNode("div", {
          ...
          !isUploading.value ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
            ...
            createBaseVNode("div", _hoisted_3$2, [
              ...
              _cache[2] || (_cache[2] = createBaseVNode("span", { class: "tip-item" }, '同名"图片+短视频"将自动识别为实况图（长按预览）', -1)),
            ...
            _cache[5] || (_cache[5] = createBaseVNode("h3", { class: "uploading-title" }, "正在上传文件...", -1)),
            createBaseVNode("div", _hoisted_7$2, [
              ...
              createBaseVNode("span", _hoisted_8$2, toDisplayString(uploadProgress.value) + "%", 1)
            ])
          ]))
        ], 34),
        ...
        uploadList.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_10$2, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(uploadList.value, (item) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_16, [
                  ...
                  createBaseVNode("div", _hoisted_18, toDisplayString(unref(formatFileSize)(item.file.size)), 1),
        ...
        uploadStats.value.total > 0 ? (openBlock(), createElementBlock("div", _hoisted_22, [
          createBaseVNode("div", _hoisted_23, [
            _cache[10] || (_cache[10] = createBaseVNode("span", { class: "stats-label" }, "总计:", -1)),
            createBaseVNode("span", _hoisted_24, toDisplayString(uploadStats.value.total), 1)
          ]),
          createBaseVNode("div", _hoisted_25, [
            _cache[11] || (_cache[11] = createBaseVNode("span", { class: "stats-label" }, "成功:", -1)),
            createBaseVNode("span", _hoisted_26, toDisplayString(uploadStats.value.success), 1)
          ]),
          createBaseVNode("div", _hoisted_27, [
            _cache[12] || (_cache[12] = createBaseVNode("span", { class: "stats-label" }, "失败:", -1)),
            createBaseVNode("span", _hoisted_28, toDisplayString(uploadStats.value.error), 1)
          ])
        ])) : createCommentVNode("", true),
        liveJobs.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_29, [
          _cache[14] || (_cache[14] = createBaseVNode("div", { class: "live-jobs-header" }, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(liveJobs.value, (job) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_31, [
                  createBaseVNode("div", _hoisted_32, "任务 " + toDisplayString(job.id), 1),
                  createBaseVNode("div", _hoisted_33, toDisplayString(statusText(job.status)), 1)
                ]),
                createVNode(_component_el_progress, {
...
const FileUploader = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-7141fe28"]]);
...
const FilePreview = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ec026d8c"]]);
export {
  FilePreview as F,
  FileUploader as a,
  useFilesStore as u
};
//# sourceMappingURL=FilePreview-BA3E1t2T.js.map
