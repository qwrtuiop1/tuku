import { a as api, f as formatFileSize, _ as _export_sfc, e as getFilePreviewUrl, h as formatTime, c as getCachedImageUrl } from "./index-CMfjVKWh.js";
/* empty css                    */
...
import { E as ElMessage, a as ElIcon, h as upload_default, a8 as monitor_default, c as ElButton, v as video_play_default, n as loading_default, z as ElProgress, I as ElMessageBox, o as document_default, a9 as clock_default, aa as check_default, ab as close_default, ac as video_pause_default, ad as ElSlider, ae as microphone_default, af as mute_default, y as full_screen_default, p as picture_default, K as refresh_default } from "./element-CUyZSw-d.js";
/* empty css                   */
/* empty css                         */
/* empty css                   */
const useFilesStore = defineStore("files", () => {
  ...
  const deleteFile = async (fileId) => {
    ...
    try {
      ...
      const msg = ((_b = (_a = error == null ? void 0 : error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "删除失败";
      ElMessage.error(msg);
      throw new Error(msg);
    }
  };
  const deleteFiles = async (fileIds) => {
    ...
    try {
      ...
      const msg = ((_b = (_a = error == null ? void 0 : error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.message) || "批量删除失败";
      ElMessage.error(msg);
      throw new Error(msg);
    }
  };
...
const _hoisted_25 = { class: "item-progress" };
...
const _hoisted_29 = { class: "stats-item" };
const _hoisted_30 = { class: "stats-value" };
const _hoisted_31 = { class: "stats-item" };
const _hoisted_32 = { class: "stats-value success" };
const _hoisted_33 = { class: "stats-item" };
const _hoisted_34 = { class: "stats-value error" };
const _hoisted_35 = {
  key: 3,
  class: "live-jobs"
};
const _hoisted_36 = { class: "live-jobs-items" };
const _hoisted_37 = { class: "job-info" };
const _hoisted_38 = { class: "job-id" };
const _hoisted_39 = { class: "job-status" };
const _hoisted_40 = { class: "job-actions" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    const processFiles = async (files) => {
      ...
      for (const file of others) {
        const uploadItem = {
          ...
          progress: 0,
          status: "pending",
          fileCategory: file.type.startsWith("image/") ? "image" : file.type.startsWith("video/") ? "video" : "unknown"
        };
    ...
    const detectMotionPhotoAsync = (file, item) => {
      detectMotionPhoto(file).then((isMotion) => {
        if (isMotion && item.status === "pending") {
          ...
          isUploading.value = true;
          createLiveJob([file]).then(() => {
            item.status = "success";
            item.progress = 100;
          }).catch((err) => {
            var _a, _b, _c;
            if (((_a = err == null ? void 0 : err.message) == null ? void 0 : _a.includes("canceled")) || (err == null ? void 0 : err.code) === "ERR_CANCELED") {
              item.status = "canceled";
            } else {
              item.status = "error";
              item.error = ((_c = (_b = err == null ? void 0 : err.response) == null ? void 0 : _b.data) == null ? void 0 : _c.message) || (err == null ? void 0 : err.message) || "实况处理失败";
            }
          }).finally(() => {
            isUploading.value = false;
            checkAllCompleted();
    ...
    async function detectMotionPhoto(file) {
      ...
      try {
        ...
        const tailBuf = await readChunk(file.size - 4, 4);
        const tailBytes = new Uint8Array(tailBuf);
        if (tailBytes[0] !== 217 || tailBytes[1] !== 255) return false;
        const searchStart = Math.max(0, file.size - 1024 * 1024);
        const searchSize = file.size - searchStart;
        const searchBuf = await readChunk(searchStart, searchSize);
        const searchBytes = new Uint8Array(searchBuf);
        let pos = 0;
        while (true) {
          pos = searchBytes.indexOf(102, pos);
          if (pos === -1 || pos < 4) break;
          if (searchBytes[pos] === 102 && // f
          searchBytes[pos + 1] === 116 && // t
          searchBytes[pos + 2] === 121 && // y
          searchBytes[pos + 3] === 112) {
            const boxLen = searchBytes[pos - 4] << 24 | searchBytes[pos - 3] << 16 | searchBytes[pos - 2] << 8 | searchBytes[pos - 1];
            if (boxLen >= 8 && boxLen <= 1024 * 1024) {
              return true;
            }
            pos += 4;
          } else {
    ...
    const uploadSingleFile = async (item) => {
      ...
      try {
        ...
        if (((_a = error == null ? void 0 : error.response) == null ? void 0 : _a.status) === 0 || ((_b = error == null ? void 0 : error.message) == null ? void 0 : _b.includes("canceled")) || (error == null ? void 0 : error.code) === "ERR_CANCELED") {
          item.status = "canceled";
          item.error = "已取消";
          return;
        }
        item.status = "error";
        item.error = ((_d = (_c = error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.message) || error.message || "上传失败";
      } finally {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(uploadList.value, (item) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_14, [
                  item.fileCategory === "image" || item.fileCategory === "animated" ? (openBlock(), createElementBlock("img", {
                    key: 0,
                    src: item.preview,
                    alt: item.file.name,
                    class: "thumbnail-image"
                  }, null, 8, _hoisted_15)) : item.fileCategory === "live" || item.fileCategory === "video" ? (openBlock(), createElementBlock("div", {
                    key: 1,
                    class: normalizeClass(["file-icon", item.fileCategory])
                  }, [
                    createVNode(_component_el_icon, null, {
                      default: withCtx(() => [
                        createVNode(unref(video_play_default))
                ...
                createBaseVNode("div", _hoisted_18, [
                  ...
                  createBaseVNode("div", _hoisted_20, [
                    createBaseVNode("span", _hoisted_21, toDisplayString(unref(formatFileSize)(item.file.size)), 1),
                    item.fileCategory === "animated" ? (openBlock(), createElementBlock("span", _hoisted_22, "动图")) : item.fileCategory === "live" ? (openBlock(), createElementBlock("span", _hoisted_23, "实况")) : item.fileCategory === "video" ? (openBlock(), createElementBlock("span", _hoisted_24, "视频")) : createCommentVNode("", true)
                  ]),
        ...
        uploadStats.value.total > 0 ? (openBlock(), createElementBlock("div", _hoisted_28, [
          createBaseVNode("div", _hoisted_29, [
            _cache[11] || (_cache[11] = createBaseVNode("span", { class: "stats-label" }, "总计:", -1)),
            createBaseVNode("span", _hoisted_30, toDisplayString(uploadStats.value.total), 1)
          ]),
          createBaseVNode("div", _hoisted_31, [
            _cache[12] || (_cache[12] = createBaseVNode("span", { class: "stats-label" }, "成功:", -1)),
            createBaseVNode("span", _hoisted_32, toDisplayString(uploadStats.value.success), 1)
          ]),
          createBaseVNode("div", _hoisted_33, [
            _cache[13] || (_cache[13] = createBaseVNode("span", { class: "stats-label" }, "失败:", -1)),
            createBaseVNode("span", _hoisted_34, toDisplayString(uploadStats.value.error), 1)
          ])
        ])) : createCommentVNode("", true),
        liveJobs.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_35, [
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(liveJobs.value, (job) => {
              return openBlock(), createElementBlock("div", {
                ...
                createBaseVNode("div", _hoisted_37, [
                  createBaseVNode("div", _hoisted_38, "任务 " + toDisplayString(job.id), 1),
                  createBaseVNode("div", _hoisted_39, toDisplayString(statusText(job.status)), 1)
                ]),
                createVNode(_component_el_progress, {
...
const FileUploader = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d790fca1"]]);
...
//# sourceMappingURL=FilePreview-nTgKnvxo.js.map
